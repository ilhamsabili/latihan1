**Hallo nama saya ILHAM SABILI. Disini saya akan menjelaskan cara penggunaan Git yang kita perlukan ialah** *Applikasi git , akun git.* Sebelum itu saya akan kasih tutorial cara penginstalan *GIT*.
